...
import { Laptop, Store, Globe, ArrowRight } from 'lucide-react';
...
const Card: React.FC<{ icon: React.ReactNode, title: string, description: string, delay: number }> = ({ icon, title, description, delay }) => (
  <motion.div 
