...
import { Check, X, Clock, Zap, ShieldCheck, Globe, Database, AlertTriangle, XCircle, CheckCircle2 } from 'lucide-react';
  ...
  return (
    <section className="px-6 max-w-7xl mx-auto w-full py-20">
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-20">
        ...
        {/* The Old Way */}
        <div className="relative p-8 rounded-3xl bg-slate-50 border border-slate-200 grayscale opacity-80 hover:opacity-100 transition-all duration-500 group">
          <div className="absolute top-6 left-6 flex items-center gap-2 text-slate-500 font-semibold uppercase tracking-wider text-xs">
          ...
          <div className="mt-12 h-64 flex items-center justify-center relative">
            ...
            <svg className="absolute inset-0 w-full h-full" viewBox="0 0 400 200">
               <path d="M 50 100 Q 100 20 150 100 T 250 100 T 350 100" fill="none" stroke="#cbd5e1" strokeWidth="2" strokeDasharray="5,5" />
               <path d="M 50 100 Q 100 180 200 100" fill="none" stroke="#cbd5e1" strokeWidth="2" strokeDasharray="5,5" />
            </svg>
            ...
            <div className="absolute left-[40%] top-[20%] bg-white p-3 rounded-lg border border-slate-200 shadow-sm">
              <span className="text-xs text-slate-600">FX Markup</span>
            </div>
            <div className="absolute left-[40%] bottom-[20%] bg-white p-3 rounded-lg border border-slate-200 shadow-sm">
            ...
            {/* Pain Points */}
             <div className="absolute top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 bg-red-50 text-red-600 px-3 py-1 rounded text-xs border border-red-100 flex items-center gap-1 font-medium">
                <Clock size={12} /> 3-5 Business Days
             </div>
          </div>

          <div className="flex justify-between text-sm text-slate-500 mt-4 px-4 border-t border-slate-200 pt-4">
        ...
        {/* The Glix Way */}
        <div className="relative p-8 rounded-3xl bg-white border border-blue-100 shadow-[0_10px_40px_rgba(59,130,246,0.1)] overflow-hidden">
           <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-blue-500 to-purple-600"></div>
           
           <div className="absolute top-6 left-6 flex items-center gap-2 text-blue-600 font-semibold uppercase tracking-wider text-xs">
          ...
          <div className="mt-12 h-64 flex items-center justify-center relative">
            ...
            {/* Nodes */}
            <div className="absolute left-[10%] bg-blue-50 text-blue-700 p-3 rounded-lg border border-blue-100 z-10 shadow-sm">
              <span className="text-xs font-semibold">Any Source</span>
            </div>
             <div className="absolute right-[10%] bg-purple-50 text-purple-700 p-3 rounded-lg border border-purple-100 z-10 shadow-sm">
          ...
          <div className="flex justify-between text-sm text-slate-700 mt-4 px-4 pt-4 border-t border-slate-100 font-medium">
             <div className="flex flex-col">
        ...
        <table className="w-full text-left border-collapse table-fixed md:table-auto">
          <thead>
            <tr className="border-b border-slate-100 bg-slate-50/50">
              <th className="p-4 md:p-6 text-sm font-bold text-slate-700 uppercase tracking-wider w-[30%]">Feature Name</th>
              <th className="p-4 md:p-6 text-sm font-bold text-slate-500 text-center w-[35%]">Traditional Banking Route</th>
              <th className="p-4 md:p-6 text-sm font-bold text-blue-600 text-center w-[35%] bg-blue-50/50 border-x border-blue-100 relative">
                 Glix Ecosystem
                 <div className="absolute top-0 right-0 bg-blue-600 text-white text-[10px] font-bold px-3 py-1 rounded-bl-xl shadow-sm">WINNER</div>
              </th>
            </tr>
          </thead>
